...
class _RemotePageState extends State<RemotePage>
  ...
  void initState() {
    ...
    _ffi.imageModel.addCallbackOnFirstImage((String peerId) {
      ...
      // build-24 task4 Phase1(相談員ビュアー軽リブランド): 接続確立(初画像)で
      //   ツールバーを折りたたみ、顧客画面を"そのまま"見せる。復活は上端ホバー/
      //   ドラッグハンドルで可能(既存 Phase4案D)。全画面はワンクリックで完全クリーンに。
      widget.toolbarState.collapse.value = true;
    });
